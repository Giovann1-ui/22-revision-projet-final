...
$app->path(PROJECT_ROOT . $ds . 'app');
$app->set('base_url', '/'); // Base URL of your app, change if in subdirectory
...
$app->set('flight.views.path', PROJECT_ROOT . $ds . 'app' . $ds . 'views'); // Path to views/templates
...
return [
	...
	'database' => [
		...
		'dbname'   => 'template_flight',   // Database name (e.g., 'flightphp')
